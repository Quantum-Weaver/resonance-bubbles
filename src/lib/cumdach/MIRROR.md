...
As of 2026-08-06 (the menu-wrapper refinement - Bubbles' cumdach
consumption, KP's word: "we are going to replace the menu wrapper in
resonance-echoes and resonance-bubles, bubbles first"), the
navigation shrine's single editable truth is:
...
file: link: Bubbles is a standalone, given-away-whole repo - a link
