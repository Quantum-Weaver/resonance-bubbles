...
| 2026-09-01 (later) | **The Console's truth, from KP's paste: Closed testing, Sep 1, 2026.** KP pasted the Play Console's app list this day; its line for Resonance Bubbles (`com.audhd.resonance_bubbles`) reads **Closed testing** with the Console's own date **Sep 1, 2026** — this same day, after the pack was trued in the row above. Upload was his hands, and his hands did it. A lamp cannot see the Console: the row above's "nothing has reached the Console" was read from the shelf's badging and this file, not from the Console — the shelf's silence at that hour, not the Console's word. Which release reached the track is not in the paste: v0.1.1 (versionCode 1001) is the signed bundle on the shelf, but the paste names no version, so the version on the track is unconfirmed by the paste. The Console's count column reads 2 for Bubbles; what it counts is not read here. *Provenance: KP's paste, 2026-09-01.* |
